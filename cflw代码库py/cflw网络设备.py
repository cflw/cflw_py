...
class E接口(enum.IntEnum):#为保证取接口全名有个优先级顺序，高位16位为优先级
	...
	e吉比特以太网 = 0x00000230	#1G=1'000M=1'000'000'000
	e千兆以太网 = 0x00000230
	e十吉以太网 = 0xffff0240	#10G=10'000M=10'000'000'000
	e万兆以太网 = 0xffff0240
	e四万兆以太网 = 0xffff0244
	e百吉以太网 = 0xffff0250	#100G=100'000M=100'000'000'000
	e十万兆以太网 = 0xffff0250
	e太比特以太网 = 0xffff0260	#1T=1'000G=1'000'000'000'000
	e百万兆以太网 = 0xffff0260
	e十太以太网 = 0xffff0270	#10T=10'000G=10'000'000'000'000
	e百太以太网 = 0xffff0280	#100T=100'000G=10'000'000'000'000
	e拍比特以太网 = 0xffff0290	#1P=1'000T
	e串行 = 0x00000400
	e虚拟局域网 = 0x00000500
	e隧道 = 0x00000600
	qx = 0x000f0700
