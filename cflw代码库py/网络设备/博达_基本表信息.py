...
class C接口表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v状态 = "up" in v状态s
			v项 = 设备.S接口表项(a接口 = v接口, a状态 = v状态, a描述 = v描述s)
			yield v项
#===============================================================================
# 网络接口表
#===============================================================================
class C网络接口表4:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v状态 = "up" in v协议s
			v项 = 设备.S网络接口表项(a接口 = v接口, a地址 = v地址, a状态 = v状态)
			yield v项
#===============================================================================
# 物理地址表
#===============================================================================
...
class C物理地址表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v项 = 设备.S物理地址表项(a地址 = v地址, a接口 = v接口, a虚拟局域网 = v虚拟局域网, a类型 = v类型)
			yield v项
#===============================================================================
# 地址解析表
#===============================================================================
class C地址解析表:
	...
	def fe行(self):
		for v行 in self.m文本.split("\n"):
			...
			v寿命 = int(v寿命s)
			v项 = 设备.S地址解析表项(a网络地址 = v网络地址, a物理地址 = v物理地址, a接口 = v接口, a寿命 = v寿命)
			yield v项